...
function register(basePath, {models, authenticator, swagger, logger, simpleDao, config, ...dependencies}) {
  const fs = require("fs");
      ...
      if (fs.existsSync(handlersPath)) {
        ...
        handlers.forEach((h) => {
          ...
          try {
            ...
            Handler.register({ authenticator, swagger, logger, simpleDao, config, ...dependencies});
          } catch (e) {
