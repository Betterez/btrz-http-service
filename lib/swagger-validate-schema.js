 ...
 */
function getRequiredBodyParameter(spec) {
...
async function validateSwaggerSchema(arg1, spec, models, req) {
  ...
  const requiredBodyParameter = getRequiredBodyParameter(_spec);

  if (requiredBodyParameter && (_req?.body === undefined || _req?.body === null)) {
